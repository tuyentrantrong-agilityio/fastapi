            ...
            if action == "subscribe":
                ...
                try:
                    ...
                    if not task:
                        ...
                        logger.debug(f"User {user_id} tried to subscribe to non-existent task {task_id}")
                        ...
                        logger.warning(f"User {user_id} tried to subscribe to task {task_id} owned by user {task.user_id}")
                    else:
