...
│   ├── test_auth.py       # Authentication tests (19)
│   ├── test_tasks.py      # Task CRUD tests (18)
│   ├── test_auth_errors.py # Authorization & errors (12)
│   └── __init__.py
│
...
```bash
cd c:\Users\tuyen\Documents\python\my_python_project\practice_1
```
